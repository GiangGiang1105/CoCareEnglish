...
class MyPreference @Inject constructor(@ApplicationContext context: Context) {
    ...
    fun saveIsCancelEssay(isCancel: Int) {
        put("isCancelEssay", isCancel)
    }

    fun getIsCancelEssay(): Int {
        return get("isCancelEssay", Int::class.java)
    }
    ...
    fun getOrderId(): String {
        return get("order_id", String::class.java)
    }
